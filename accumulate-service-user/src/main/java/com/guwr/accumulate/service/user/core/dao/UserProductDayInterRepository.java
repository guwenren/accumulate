 ...
 * Created by gwr
 * Description
 * Path com.accumulate.service.user.core.dao.UserProductDayInterRepository
 * Date 2016/8/13
 * Time 21:19
 */
public interface UserProductDayInterRepository extends JpaRepository<UserProductDayInter, Integer> {
}
