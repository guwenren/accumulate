 ...
 * Created by gwr
 * Description  用户收益中间表
 * Path com.guwr.accumulate.facade.wmps.entity.ProductUserPreinter
 * Date 2016/8/21
 * Time 14:32
 */
@Entity
@Table(name = "tbl_wmps_user_preinter")
public class ProductUserPreinter implements Serializable {
