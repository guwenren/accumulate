...
<body class="hold-transition skin-blue sidebar-mini  >sidebar-collapse ">
	<div class="wrapper">
        ...
        <jsp:include page="${request.contextPath}/static/common/header.jsp"/>

        <jsp:include page="${request.contextPath}/static/common/left.jsp"/>
		...
		<jsp:include page="${request.contextPath}/static/common/foot.jsp"/>
    ...
    <script src="${request.contextPath}/static/js/conf.1.js?time=1"></script>
